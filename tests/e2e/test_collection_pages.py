...
def test_collection_page_headline_no_percent_change(lazy_page, live_server_url, enable_early_years):
    ...
    expect(lazy_page.get_by_text("Increase of 3.1% from 2021/22 to 2024/25.")).to_be_visible()
    expect(lazy_page.get_by_text("Increase of 3.5% from 2021/22 to 2024/25.")).to_be_visible()
    headline_column = lazy_page.locator(".datagovuk-headline__column").first
