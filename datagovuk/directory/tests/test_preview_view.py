...
class TestPreviewView:
    ...
    def test_preview_renders_table(self, mock_solr, mock_fetch_csv, rf):
    ...
    @patch("datagovuk.directory.views.fetch_csv")
    @patch("datagovuk.directory.views.get_solr_client")
    def test_preview_limits_to_four_data_rows(self, mock_solr, mock_fetch_csv, rf):
        mock_solr.return_value.search.return_value.docs = [make_solr_doc()]
    ...
    @patch("datagovuk.directory.views.get_solr_client")
    def test_preview_returns_404_when_dataset_not_found(self, mock_solr, rf):
    ...
    @patch("datagovuk.directory.views.get_solr_client")
    def test_preview_returns_404_when_resource_not_in_dataset(self, mock_solr, rf):
        mock_solr.return_value.search.return_value.docs = [make_solr_doc()]
