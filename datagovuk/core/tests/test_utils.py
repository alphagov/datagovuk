...
def test_is_numeric_integer_string_is_numeric():
    assert is_numeric("42") is True


def test_is_numeric_float_string_is_numeric():
    assert is_numeric("3.14") is True


def test_is_numeric_negative_number_is_numeric():
    assert is_numeric("-7") is True


def test_is_numeric_plain_text_is_not_numeric():
    assert is_numeric("hello") is False


def test_is_numeric_empty_string_is_not_numeric():
    assert is_numeric("") is False


def test_is_numeric_none_is_not_numeric():
    assert is_numeric(None) is False


def test_is_numeric_mixed_string_is_not_numeric():
    assert is_numeric("12abc") is False


def test_is_numeric_decimal_without_leading_zero_is_numeric():
    assert is_numeric(".5") is True


def test_is_numeric_negative_decimal_without_leading_zero_is_numeric():
    assert is_numeric("-.5") is True


def test_is_numeric_scientific_notation_is_not_numeric():
    assert is_numeric("1e3") is False


def test_is_numeric_infinity_is_not_numeric():
    assert is_numeric("inf") is False


def test_is_numeric_nan_is_not_numeric():
    assert is_numeric("nan") is False


def test_build_table_data_text_columns():
    headers = ["name", "city"]
...
def test_build_table_data_numeric_column_detection():
    headers = ["name", "score"]
    rows = [["John", "95"], ["Doe", "87"]]
...
def test_build_table_data_row_cell_format():
    headers = ["label", "value"]
    rows = [["item", "42"]]
...
def test_build_table_data_empty_inputs():
...
def test_build_table_data_short_row_does_not_affect_column_format():
    headers = ["name", "score"]
    rows = [["John"], ["Doe", "87"]]
...
def test_build_table_data_no_rows_headings_default_to_text():
...
def test_build_table_data_mixed_numeric_column_uses_numeric_format():
    headers = ["value"]
