...
Extracted rows for fuel as 'Total all generating companies', 'Total low carbon generation [note 14]', 'Total fossil fuel generation [note 15]' for Generation type as 'All generating companies' from Table 5.6B (Electricity generated, GWh). Removed the references to notes, transposed data with the years, and saved to [electricity-generation/electricity-generation.csv](electricity-generation/electricity-generation.csv).
